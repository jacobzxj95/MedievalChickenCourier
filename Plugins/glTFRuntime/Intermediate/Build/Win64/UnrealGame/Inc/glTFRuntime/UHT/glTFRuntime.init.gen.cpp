...
void EmptyLinkFunctionForGeneratedCodeglTFRuntime_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_glTFRuntime()
	{
		if (!Z_Registration_Info_UPackage__Script_glTFRuntime.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeAnimationCurveRemapper__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeAnimationFrameRotationRemapper__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeAnimationFrameTranslationRemapper__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeBoneBoundsFilter__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeBoneRemapper__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeError__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeHttpProgress__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeHttpResponse__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_glTFRuntime_glTFRuntimeMeshLODAsync__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_glTFRuntime(Z_Construct_UPackage__Script_glTFRuntime, TEXT("/Script/glTFRuntime"), Z_Registration_Info_UPackage__Script_glTFRuntime, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x4A09726D, 0xDC06A549));
